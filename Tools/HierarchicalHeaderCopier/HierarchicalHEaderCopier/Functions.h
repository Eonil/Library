...
NSURL*	make_relative_path_url(NSURL* toAbsoluteBase, NSURL* fromAbsoluteItem);
NSURL*	make_absolute_path_url(NSURL* base, NSURL* relative);

BOOL	is_existing_dir(NSURL* url);
BOOL	is_absolute_url(NSURL* url);
 ...
 */
void	copy_all_files(NSURL* absolute_source, NSURL* absolute_destination, BOOL (^query_whether_to_copy_dir)(NSURL* absoluteSourceURL), BOOL (^query_whether_to_copy_file)(NSURL* absoluteSourceURL));
...
void	copy_all_only_headers(NSURL* absolute_source, NSURL* absolute_destination);